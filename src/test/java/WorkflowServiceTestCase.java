...
public class WorkflowServiceTestCase extends junit.framework.TestCase {
    public WorkflowServiceTestCase(String name) {
        super(name);
    }
    @Test
    public void testWorkflowServiceHttpPortWSDL() throws Exception {
        javax.xml.rpc.ServiceFactory serviceFactory = javax.xml.rpc.ServiceFactory.newInstance();
        java.net.URL url = new java.net.URL(new WorkflowServiceLocator().getWorkflowServiceHttpPortAddress() + "?WSDL");
        javax.xml.rpc.Service service = serviceFactory.createService(url, new WorkflowServiceLocator().getServiceName());
        assertTrue(service != null);
    }

    public void test1WorkflowServiceHttpPortGetWorkflowRequest() throws Exception {
        WorkflowServiceHttpBindingStub binding;
        try {
            binding = (WorkflowServiceHttpBindingStub)
                          new WorkflowServiceLocator().getWorkflowServiceHttpPort();
        }
        ...
        // Test operation
        WorkflowRequestInfo value = null;
    ...
    public void test2WorkflowServiceHttpPortGetHendledWorkflowRequestList() throws Exception {
        ...
        // Test operation
        WorkflowRequestInfo[] value = null;
        value = binding.getHendledWorkflowRequestList(0, 0, 0, 0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test4WorkflowServiceHttpPortSubmitWorkflowRequest() throws Exception {
        ...
        // Test operation
        String value = null;
        value = binding.submitWorkflowRequest(new WorkflowRequestInfo(), 0, 0, new String(), new String());
        // TBD - validate results
    }
    ...
    public void test5WorkflowServiceHttpPortGetMyWorkflowRequestCount4OS() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getMyWorkflowRequestCount4OS(0, new String[0], true);
        // TBD - validate results
    }
    ...
    public void test6WorkflowServiceHttpPortGetTodoData() throws Exception {
        ...
        // Test operation
        String value = null;
        value = binding.getTodoData(new String());
        // TBD - validate results
    }
    ...
    public void test7WorkflowServiceHttpPortGetCCWorkflowRequestList4OS() throws Exception {
        ...
        // Test operation
        WorkflowRequestInfo[] value = null;
        value = binding.getCCWorkflowRequestList4OS(0, 0, 0, 0, new String[0], true);
        // TBD - validate results
    }
    ...
    public void test8WorkflowServiceHttpPortGetLeaveDays() throws Exception {
        ...
        // Test operation
        String value = null;
        value = binding.getLeaveDays(new String(), new String(), new String(), new String(), new String());
        // TBD - validate results
    }
    ...
    public void test9WorkflowServiceHttpPortGetHendledWorkflowRequestList4Ofs() throws Exception {
        ...
        // Test operation
        WorkflowRequestInfo[] value = null;
        value = binding.getHendledWorkflowRequestList4Ofs(0, 0, 0, 0, new String[0], true);
        // TBD - validate results
    }
    ...
    public void test10WorkflowServiceHttpPortGetCreateWorkflowList() throws Exception {
        ...
        // Test operation
        WorkflowBaseInfo[] value = null;
        value = binding.getCreateWorkflowList(0, 0, 0, 0, 0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test11WorkflowServiceHttpPortGetProcessedWorkflowRequestCount() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getProcessedWorkflowRequestCount(0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test12WorkflowServiceHttpPortDoCreateRequest() throws Exception {
        ...
        // Test operation
        String value = null;
        value = binding.doCreateRequest(new WorkflowRequestInfo(), 0);
        // TBD - validate results
    }
    ...
    public void test13WorkflowServiceHttpPortDoCreateWorkflowRequest() throws Exception {
        ...
        // Test operation
        String value = null;
        value = binding.doCreateWorkflowRequest(new WorkflowRequestInfo(), 0);
        // TBD - validate results
    }
    ...
    public void test14WorkflowServiceHttpPortGetToDoWorkflowRequestCount4OS() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getToDoWorkflowRequestCount4OS(0, new String[0], true);
        // TBD - validate results
    }
    ...
    public void test16WorkflowServiceHttpPortGetProcessedWorkflowRequestList() throws Exception {
        ...
        // Test operation
        WorkflowRequestInfo[] value = null;
        value = binding.getProcessedWorkflowRequestList(0, 0, 0, 0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test18WorkflowServiceHttpPortGetCreateWorkflowTypeList() throws Exception {
        ...
        // Test operation
        WorkflowBaseInfo[] value = null;
        value = binding.getCreateWorkflowTypeList(0, 0, 0, 0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test19WorkflowServiceHttpPortGetHendledWorkflowRequestCount4Ofs() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getHendledWorkflowRequestCount4Ofs(0, new String[0], true);
        // TBD - validate results
    }
    ...
    public void test20WorkflowServiceHttpPortGetMyWorkflowRequestList4OS() throws Exception {
        ...
        // Test operation
        WorkflowRequestInfo[] value = null;
        value = binding.getMyWorkflowRequestList4OS(0, 0, 0, 0, new String[0], true);
        // TBD - validate results
    }
    ...
    public void test21WorkflowServiceHttpPortGetProcessedWorkflowRequestList4OS() throws Exception {
        ...
        // Test operation
        WorkflowRequestInfo[] value = null;
        value = binding.getProcessedWorkflowRequestList4OS(0, 0, 0, 0, new String[0], true);
        // TBD - validate results
    }
    ...
    public void test22WorkflowServiceHttpPortGetForwardWorkflowRequestCount() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getForwardWorkflowRequestCount(0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test23WorkflowServiceHttpPortGetToDoWorkflowRequestCount() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getToDoWorkflowRequestCount(0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test24WorkflowServiceHttpPortGivingOpinions() throws Exception {
        ...
        // Test operation
        String value = null;
        value = binding.givingOpinions(0, 0, new String());
        // TBD - validate results
    }
    ...
    public void test25WorkflowServiceHttpPortGetCCWorkflowRequestList() throws Exception {
        ...
        // Test operation
        WorkflowRequestInfo[] value = null;
        value = binding.getCCWorkflowRequestList(0, 0, 0, 0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test26WorkflowServiceHttpPortGetProcessedWorkflowRequestCount4OS() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getProcessedWorkflowRequestCount4OS(0, new String[0], true);
        // TBD - validate results
    }
    ...
    public void test27WorkflowServiceHttpPortGetBeRejectWorkflowRequestCount() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getBeRejectWorkflowRequestCount(0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test28WorkflowServiceHttpPortForward2WorkflowRequest() throws Exception {
        ...
        // Test operation
        String value = null;
        value = binding.forward2WorkflowRequest(0, new String(), new String(), 0, new String());
        // TBD - validate results
    }
    ...
    public void test29WorkflowServiceHttpPortGetAllWorkflowRequestList() throws Exception {
        ...
        // Test operation
        WorkflowRequestInfo[] value = null;
        value = binding.getAllWorkflowRequestList(0, 0, 0, 0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test30WorkflowServiceHttpPortGetToDoWorkflowRequestList() throws Exception {
        ...
        // Test operation
        WorkflowRequestInfo[] value = null;
        value = binding.getToDoWorkflowRequestList(0, 0, 0, 0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test31WorkflowServiceHttpPortGetCCWorkflowRequestCount4OS() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getCCWorkflowRequestCount4OS(0, new String[0], true);
        // TBD - validate results
    }
    ...
    public void test32WorkflowServiceHttpPortGetHendledWorkflowRequestCount() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getHendledWorkflowRequestCount(0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test33WorkflowServiceHttpPortGetToDoWorkflowRequestList4OS() throws Exception {
        ...
        // Test operation
        WorkflowRequestInfo[] value = null;
        value = binding.getToDoWorkflowRequestList4OS(0, 0, 0, 0, new String[0], true);
        // TBD - validate results
    }
    ...
    public void test34WorkflowServiceHttpPortGetToBeReadWorkflowRequestCount() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getToBeReadWorkflowRequestCount(0, new String[0], true);
        // TBD - validate results
    }
    ...
    public void test35WorkflowServiceHttpPortGetCreateWorkflowCount() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getCreateWorkflowCount(0, 0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test36WorkflowServiceHttpPortForwardWorkflowRequest() throws Exception {
        ...
        // Test operation
        String value = null;
        value = binding.forwardWorkflowRequest(0, new String(), new String(), 0, new String());
        // TBD - validate results
    }
    ...
    public void test37WorkflowServiceHttpPortGetToBeReadWorkflowRequestList() throws Exception {
        ...
        // Test operation
        WorkflowRequestInfo[] value = null;
        value = binding.getToBeReadWorkflowRequestList(0, 0, 0, 0, new String[0], true);
        // TBD - validate results
    }
    ...
    public void test38WorkflowServiceHttpPortGetBeRejectWorkflowRequestList() throws Exception {
        ...
        // Test operation
        WorkflowRequestInfo[] value = null;
        value = binding.getBeRejectWorkflowRequestList(0, 0, 0, 0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test39WorkflowServiceHttpPortGetCCWorkflowRequestCount() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getCCWorkflowRequestCount(0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test40WorkflowServiceHttpPortGetAllWorkflowRequestCount() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getAllWorkflowRequestCount(0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test41WorkflowServiceHttpPortGetDoingWorkflowRequestCount() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getDoingWorkflowRequestCount(0, new String[0], true);
        // TBD - validate results
    }
    ...
    public void test42WorkflowServiceHttpPortGetForwardWorkflowRequestList() throws Exception {
        ...
        // Test operation
        WorkflowRequestInfo[] value = null;
        value = binding.getForwardWorkflowRequestList(0, 0, 0, 0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test43WorkflowServiceHttpPortGetMyWorkflowRequestList() throws Exception {
        ...
        // Test operation
        WorkflowRequestInfo[] value = null;
        value = binding.getMyWorkflowRequestList(0, 0, 0, 0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test44WorkflowServiceHttpPortGetMyWorkflowRequestCount() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getMyWorkflowRequestCount(0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test45WorkflowServiceHttpPortGetWorkflowNewFlag() throws Exception {
        ...
        // Test operation
        String[] value = null;
        value = binding.getWorkflowNewFlag(new String[0], new String());
        // TBD - validate results
    }
    ...
    public void test46WorkflowServiceHttpPortWriteWorkflowReadFlag() throws Exception {
        ...
        // Test operation
        binding.writeWorkflowReadFlag(new String(), new String());
        // TBD - validate results
    }
    ...
    public void test47WorkflowServiceHttpPortGetCreateWorkflowTypeCount() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.getCreateWorkflowTypeCount(0, new String[0]);
        // TBD - validate results
    }
    ...
    public void test48WorkflowServiceHttpPortGetWorkflowRequestLogs() throws Exception {
        ...
        // Test operation
        WorkflowRequestLog[] value = null;
        value = binding.getWorkflowRequestLogs(new String(), new String(), 0, 0, 0);
        // TBD - validate results
    }
    ...
    public void test50WorkflowServiceHttpPortGetUserId() throws Exception {
        ...
        // Test operation
        String value = null;
        value = binding.getUserId(new String(), new String());
        // TBD - validate results
    }
    ...
    public void test51WorkflowServiceHttpPortGetDoingWorkflowRequestList() throws Exception {
        ...
        // Test operation
        WorkflowRequestInfo[] value = null;
        value = binding.getDoingWorkflowRequestList(0, 0, 0, 0, new String[0], true);
        // TBD - validate results
    }
