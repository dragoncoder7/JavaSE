...
public class WorkflowRequestTableRecord  implements java.io.Serializable {
    ...
    private com.test.WorkflowRequestTableField[] workflowRequestTableFields;
    ...
    public WorkflowRequestTableRecord(
           ...
           com.test.WorkflowRequestTableField[] workflowRequestTableFields) {
     ...
     */
    public com.test.WorkflowRequestTableField[] getWorkflowRequestTableFields() {
        return workflowRequestTableFields;
    }
     ...
     */
    public void setWorkflowRequestTableFields(com.test.WorkflowRequestTableField[] workflowRequestTableFields) {
        this.workflowRequestTableFields = workflowRequestTableFields;
    }
