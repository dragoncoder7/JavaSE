...
public class WorkflowMainTableInfo  implements java.io.Serializable {
    private com.test.WorkflowRequestTableRecord[] requestRecords;
    ...
    public WorkflowMainTableInfo(
           com.test.WorkflowRequestTableRecord[] requestRecords,
     ...
     */
    public com.test.WorkflowRequestTableRecord[] getRequestRecords() {
        return requestRecords;
    }
     ...
     */
    public void setRequestRecords(com.test.WorkflowRequestTableRecord[] requestRecords) {
        this.requestRecords = requestRecords;
    }
