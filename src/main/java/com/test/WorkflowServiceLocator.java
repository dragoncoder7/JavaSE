...
public class WorkflowServiceLocator extends org.apache.axis.client.Service implements com.test.WorkflowService {
    ...
    private java.lang.String WorkflowServiceHttpPort_address = "http://10.10.1.58/services/WorkflowService";
    ...
    public com.test.WorkflowServicePortType getWorkflowServiceHttpPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.test.WorkflowServicePortType getWorkflowServiceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.test.WorkflowServiceHttpBindingStub _stub = new com.test.WorkflowServiceHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.test.WorkflowServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.test.WorkflowServiceHttpBindingStub _stub = new com.test.WorkflowServiceHttpBindingStub(new java.net.URL(WorkflowServiceHttpPort_address), this);
                _stub.setPortName(getWorkflowServiceHttpPortWSDDServiceName());
                return _stub;
            }
        }
