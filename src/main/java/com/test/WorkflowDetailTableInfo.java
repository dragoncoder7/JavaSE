...
public class WorkflowDetailTableInfo  implements java.io.Serializable {
    ...
    private com.test.WorkflowRequestTableRecord[] workflowRequestTableRecords;
    ...
    public WorkflowDetailTableInfo(
           ...
           com.test.WorkflowRequestTableRecord[] workflowRequestTableRecords) {
     ...
     */
    public com.test.WorkflowRequestTableRecord[] getWorkflowRequestTableRecords() {
        return workflowRequestTableRecords;
    }
     ...
     */
    public void setWorkflowRequestTableRecords(com.test.WorkflowRequestTableRecord[] workflowRequestTableRecords) {
        this.workflowRequestTableRecords = workflowRequestTableRecords;
    }
