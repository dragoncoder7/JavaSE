...
public class HrmServiceLocator extends org.apache.axis.client.Service implements WebServiceTest.HrmService {
    ...
    private java.lang.String HrmServiceHttpPort_address = "http://10.10.1.58/services/HrmService";
    ...
    public WebServiceTest.HrmServicePortType getHrmServiceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            WebServiceTest.HrmServiceHttpBindingStub _stub = new WebServiceTest.HrmServiceHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (WebServiceTest.HrmServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                WebServiceTest.HrmServiceHttpBindingStub _stub = new WebServiceTest.HrmServiceHttpBindingStub(new java.net.URL(HrmServiceHttpPort_address), this);
                _stub.setPortName(getHrmServiceHttpPortWSDDServiceName());
                return _stub;
            }
        }
