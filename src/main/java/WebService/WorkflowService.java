 ...
 * 
 */
@WebServiceClient(name = "WorkflowService", targetNamespace = "webservices.services.weaver.com.cn", wsdlLocation = "http://10.10.1.58/services/WorkflowService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://10.10.1.58/services/WorkflowService?wsdl");
